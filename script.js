...
/* Function Paginate */
function paginate(items, itemsPerPage, currentPage, container) {
...
/* REMOVE class name ACTIVE from all elements */
...
function addActiveClass(currentPage) {
    const pageLink = document.getElementsByClassName('pagination-item');
...
paginate(data, rowsPerPage, currentPage, container)
